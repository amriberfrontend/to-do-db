const taskTitle = <HTMLInputElement> document.getElementById("title");
const taskDescription = <HTMLInputElement> document.getElementById("description");
const save = <HTMLButtonElement> document.getElementById("save");
const taskList = <HTMLOListElement> document.getElementById("view__list");
...
openOrCreateDB.onupgradeneeded = (e: IDBVersionChangeEvent) => {
